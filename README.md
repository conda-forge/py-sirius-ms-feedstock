...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/py-sirius-ms-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/py-sirius-ms-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add py-sirius-ms
# for installing globally
pixi global install py-sirius-ms
```
...
It is possible to list all of the versions of `py-sirius-ms` available on your platform:
...
```
pixi search py-sirius-ms --channel conda-forge
```
