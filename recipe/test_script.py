...
time.sleep(10)
# todo currently running simplified tests until sirius-ms has proper headless mode.
...
with open('sirius.version', 'w') as f:
    f.write(api.infos().get_info().sirius_version)
